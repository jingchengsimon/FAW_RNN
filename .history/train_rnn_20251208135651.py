...
if __name__ == "__main__":
    ...
    results_rnn = network_train(
        ...
        weight_decay=2e-4,  # L2 regularization, balanced to prevent overfitting without causing underfitting
        dropout_rate=0.4,  # CNN encoder dropout rate, balanced value
        use_early_stopping=True,  # Enable early stopping to find best generalization point
        early_stopping_patience=10,  # Early stopping patience value
