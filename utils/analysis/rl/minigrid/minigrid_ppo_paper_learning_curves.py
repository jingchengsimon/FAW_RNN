...
Reference style: results/figs/rl/minigrid/redblue_l1.png

Data source: ``results/data/rl/minigrid/runs/`` on the selected result root.
"""
...
RESULTS_PATH = PROJECT_ROOT / "results/data/rl/minigrid/runs"
OUTPUT_DIR = PROJECT_ROOT / "results/figs/rl/minigrid"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# Remote amarel path
REMOTE_HOST = "amarel"
REMOTE_BASE = "/cache/home/js3269/projects/aim3_gawf_rnn/results/data/rl/minigrid/runs"
