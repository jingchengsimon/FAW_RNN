...
from utils.analysis.clutter.supple2_gate_context import _balanced_masks, _marginal_variance
...
def parse_args() -> argparse.Namespace:
    ...
    base = "./results/data/clutter/runs/best_6model_param_matched_40h"
    parser.add_argument(
        "--lstm_ckpt",
        default=(
