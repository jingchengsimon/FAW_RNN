...
``results/figs/D_variance_decomposition/`` and the official PDF is written to the configured
...
from utils.analysis.variance_decomposition import CM_FACTORS, RepeatedDecomposition
