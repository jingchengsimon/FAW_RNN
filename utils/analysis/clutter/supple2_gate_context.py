...
from utils.analysis.clutter.fig3_gate_distribution import _gini, iter_gate_chunks
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data_dir", default="./source/clutter/stimuli")
    parser.add_argument(
        "--data_suffix",
...
def _marginal_variance(cell_mean: np.ndarray) -> dict[str, Any]:
    """Match utils.analysis/5_dpca_marginalized_variance.py on a balanced 9x10 tensor."""
