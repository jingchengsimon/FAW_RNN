...
``pick_cuda_device_index_prefer_no_python()`` (same idea as ``run_task.py clutter``, but
...
from utils.training.clutter.clutter_train_helpers import pick_cuda_device_index_prefer_no_python
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--ckpt_dir",
        type=str,
        default="./results/data/clutter/runs/sector_40h_adamw_0409",
...
# ``utils.analysis.anal_helpers`` (``build_train_dataset_allchars``, ``build_rnn_allchars_model_from_sector_ckpt``)
