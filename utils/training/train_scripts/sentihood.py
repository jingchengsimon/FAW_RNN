...
This entry point intentionally reuses ``utils.training.text.text_task_models`` from IMDB. The
...
Paper-style LSTM-Final smoke/repro command after preprocessing::
    ...
    python run_task.py sentihood --model_types lstm --hidden_sizes 50 \
...
from utils.training.text.text_sentihood_data import build_sentihood_loaders, load_meta
from utils.training.text.text_sentihood_metrics import compute_sentihood_metrics
