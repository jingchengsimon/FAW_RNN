...
Outputs (in ``--save_dir`` or ``results/data/rl/minigrid/runs/<result_suffix>``):
...
from utils.training.atari.atari_train_utils import compute_gae, ensure_dir, save_json, select_device
from utils.training.atari.atari_train_utils import set_atari_seed
from utils.training.minigrid.minigrid_envs import make_vector_minigrid_env
from utils.training.minigrid.minigrid_ppo_paper_models import (
...
def train(args: argparse.Namespace) -> dict[str, Any]:
    ...
    save_dir = args.save_dir or os.path.join("results", "data", "rl", "minigrid", "runs", args.result_suffix)
    ensure_dir(save_dir)
