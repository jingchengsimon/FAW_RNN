...
from utils.training.clutter.clutter_train_helpers import (
    LoggingHelper,
    PathHelper,
    create_datasets,
    set_seed,
...
from utils.training.clutter.clutter_train_sector import compute_fg_transition_masks

from utils.training.clutter.clutter_train_engine import (
...
if __name__ == "__main__":
    ...
    results_dir = os.path.join(results_root, "data", "clutter", "runs", args.result_suffix)
