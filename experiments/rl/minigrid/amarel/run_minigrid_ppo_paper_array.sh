...
#SBATCH --output=experiments/rl/minigrid/amarel/artifacts/minigrid_ppo_paper/%A_%a.out
#SBATCH --error=experiments/rl/minigrid/amarel/artifacts/minigrid_ppo_paper/%A_%a.err
