...
#SBATCH --output=experiments/rl/minigrid/amarel/artifacts/minigrid/%A_%a.out
#SBATCH --error=experiments/rl/minigrid/amarel/artifacts/minigrid/%A_%a.err
...
ART_ROOT="$ROOT/experiments/rl/minigrid/amarel/artifacts/minigrid"
