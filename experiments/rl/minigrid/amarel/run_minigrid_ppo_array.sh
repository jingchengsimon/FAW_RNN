...
#SBATCH --output=experiments/rl/minigrid/amarel/artifacts/minigrid_ppo/%A_%a.out
#SBATCH --error=experiments/rl/minigrid/amarel/artifacts/minigrid_ppo/%A_%a.err
...
cd "$ROOT"
ART="$ROOT/experiments/rl/minigrid/amarel/artifacts/minigrid_ppo"; STATUS_DIR="$ART/status"
