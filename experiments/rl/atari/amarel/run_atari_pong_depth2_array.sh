...
#SBATCH --output=experiments/rl/atari/amarel/artifacts/atari_pong_depth2/%A_%a.out
#SBATCH --error=experiments/rl/atari/amarel/artifacts/atari_pong_depth2/%A_%a.err
...
cd "$ROOT"
ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_pong_depth2"
