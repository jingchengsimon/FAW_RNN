...
#SBATCH --output=experiments/rl/atari/amarel/artifacts/atari_gawf_fs4_stack4_video/%A_%a.out
#SBATCH --error=experiments/rl/atari/amarel/artifacts/atari_gawf_fs4_stack4_video/%A_%a.err
