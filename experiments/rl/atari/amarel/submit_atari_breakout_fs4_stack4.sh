...
MATCH_RUNNER="$ROOT/experiments/rl/atari/amarel/prepare_atari_breakout_fs4_stack4_match.sh"
ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_breakout_fs4_stack4_l1"
SMOKE_ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_breakout_fs4_stack4_smoke"
MATCH_ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_breakout_fs4_stack4_match"
