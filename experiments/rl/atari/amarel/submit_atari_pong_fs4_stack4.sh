...
L1_RUNNER="$ROOT/experiments/rl/atari/amarel/run_atari_pong_fs4_stack4_l1_array.sh"
L2_RUNNER="$ROOT/experiments/rl/atari/amarel/run_atari_pong_fs4_stack4_l2_array.sh"
MATCH_RUNNER="$ROOT/experiments/rl/atari/amarel/prepare_atari_pong_fs4_stack4_match.sh"
L1_ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_pong_fs4_stack4_l1"
L2_ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_pong_fs4_stack4_l2"
SMOKE_ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_pong_fs4_stack4_smoke"
MATCH_ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_pong_fs4_stack4_match"
