...
#SBATCH --output=experiments/rl/atari/amarel/artifacts/atari_breakout_fs4_stack4_l1/%j_match.out
#SBATCH --error=experiments/rl/atari/amarel/artifacts/atari_breakout_fs4_stack4_l1/%j_match.err
