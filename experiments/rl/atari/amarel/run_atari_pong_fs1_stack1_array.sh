...
#SBATCH --output=experiments/rl/atari/amarel/artifacts/atari_pong_fs1_stack1/%A_%a.out
#SBATCH --error=experiments/rl/atari/amarel/artifacts/atari_pong_fs1_stack1/%A_%a.err
