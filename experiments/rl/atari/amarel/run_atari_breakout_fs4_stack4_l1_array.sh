...
#SBATCH --output=experiments/rl/atari/amarel/artifacts/atari_breakout_fs4_stack4_l1/%A_%a.out
#SBATCH --error=experiments/rl/atari/amarel/artifacts/atari_breakout_fs4_stack4_l1/%A_%a.err
...
# Quota guard; see experiments/rl/atari/amarel/scratch_quota_guard.py for why running out
