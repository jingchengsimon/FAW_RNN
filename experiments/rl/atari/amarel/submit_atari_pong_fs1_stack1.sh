...
ART_ROOT="$ROOT/experiments/rl/atari/amarel/artifacts/atari_pong_fs1_stack1"
MATCH_ART="$ROOT/experiments/rl/atari/amarel/artifacts/atari_param_match_fs1_stack1"
ARRAY_SPEC="0-69"
