...
usage() {
  cat <<'EOF'
Usage: ./experiments/remote/fetch_results.sh [options] [subdir]
...
Examples:
  ./experiments/remote/fetch_results.sh --since .remote_wrapper_20260510_230000_123.marker
  ./experiments/remote/fetch_results.sh train_data/gen_phase3_short_4h_ep100
  ./experiments/remote/fetch_results.sh --all
EOF
}
