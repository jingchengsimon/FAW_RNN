...
#SBATCH --output=experiments/amarel/artifacts/atari_gawf_single_episode_videos/%A_%a.out
#SBATCH --error=experiments/amarel/artifacts/atari_gawf_single_episode_videos/%A_%a.err
