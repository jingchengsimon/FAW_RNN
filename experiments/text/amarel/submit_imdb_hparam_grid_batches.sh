...
#
# Usage:
#   bash experiments/text/amarel/submit_imdb_hparam_grid_batches.sh
#   bash experiments/text/amarel/submit_imdb_hparam_grid_batches.sh --start-task 0 --end-task 3   # dry-run slice
#
...
SUBMIT_LOG_DIR="$ROOT/experiments/text/amarel/artifacts/imdb_lstm_hparam_grid"
