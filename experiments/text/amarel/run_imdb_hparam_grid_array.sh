...
#SBATCH --output=experiments/text/amarel/artifacts/imdb_lstm_hparam_grid/%A_%a.out
#SBATCH --error=experiments/text/amarel/artifacts/imdb_lstm_hparam_grid/%A_%a.err

# Run one IMDB LSTM hparam-grid task. Submit via
# experiments/text/amarel/submit_imdb_hparam_grid_batches.sh.
...
ART_ROOT="$ROOT/experiments/text/amarel/artifacts/$GRID_NAME"
