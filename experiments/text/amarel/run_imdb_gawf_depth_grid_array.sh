...
#SBATCH --output=experiments/text/amarel/artifacts/imdb_gawf_depth_grid/%A_%a.out
#SBATCH --error=experiments/text/amarel/artifacts/imdb_gawf_depth_grid/%A_%a.err
