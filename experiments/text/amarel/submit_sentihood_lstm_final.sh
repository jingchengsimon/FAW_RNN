...
#
# Usage:
#   bash experiments/text/amarel/submit_sentihood_lstm_final.sh
#
...
echo "next=python experiments/text/amarel/check_sentihood_lstm_final_status.py --results_dir '$AIM3_RESULTS_PATH'"
